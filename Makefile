...
CORE_OBJECTS = \
	...
	$(OBJ_DIR)/FitParameters.o \
	$(OBJ_DIR)/GVVLikelihood.o
FIT_OBJECTS = $(CORE_OBJECTS) $(OBJ_DIR)/Fit.o
...
$(OBJ_DIR)/FitParameters.o: framework/fit/FitParameters.cu framework/fit/FitParameters.h | $(OBJ_DIR)
	$(NVCC) $(ROOT_INCLUDES) -c -w $< $(PROJECT_INCLUDES) $(COMPILE_FLAGS) -o $@

$(OBJ_DIR)/GVVLikelihood.o: framework/likelihood/GVVLikelihood.cu framework/likelihood/GVVLikelihood.h | $(OBJ_DIR)
	$(NVCC) $(ROOT_INCLUDES) -c -w $< $(PROJECT_INCLUDES) $(COMPILE_FLAGS) -o $@

$(OBJ_DIR)/Fit.o: app/Fit.cu framework/fit/MinuitFCN.h | $(OBJ_DIR)
	$(NVCC) $(ROOT_INCLUDES) -c -w $< $(PROJECT_INCLUDES) $(COMPILE_FLAGS) -o $@
...
$(TEST_BIN_DIR)/test_fit_parameters.exe: tests/test_fit_parameters.cu $(OBJ_DIR)/FitParameters.o $(OBJ_DIR)/WaveRegistry.o $(OBJ_DIR)/Model.o | $(TEST_BIN_DIR)
	$(NVCC) -w $< $(OBJ_DIR)/FitParameters.o $(OBJ_DIR)/WaveRegistry.o \
