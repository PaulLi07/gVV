...
# Project-local runtime/build environment for GVV v1.
...
export LD_LIBRARY_PATH="/usr/local/lib:$GVV_CUDA_ROOT/lib:$GVV_ROOTSYS/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
hash -r
