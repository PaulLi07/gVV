...
GVVSample::GVVSample(const std::string& label)
    : label_(label), entries_(0), F_matrix_(nullptr), amp2_(nullptr)
{
...
void GVVSample::UploadAndBuildF()
{
    ...
    if (F_matrix_ != nullptr || amp2_ != nullptr) {
